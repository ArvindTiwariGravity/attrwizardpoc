		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Attribute Wizard",
									"targetURL": "#comsapattribute-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapattribute-display": {
								"semanticObject": "comsapattribute",
								"action": "display",
								"description": "Attribute Wizard",
								"title": "Attribute Wizard",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.attribute",
									"url": sap.ui.require.toUrl("com/sap/attribute")
								}
							}
						}
					}
